    ...
    juce::Slider& slider)
{
    ...
    g.setColour(enabled ? Colour(122u, 162u, 247u) : Colours::darkgrey );
    g.fillEllipse(bounds);

    g.setColour(enabled? Colour(65u, 72u, 104u) : Colours::grey);
    ...
    bool shouldDrawButtonAsDown)
{
    ...
    if (auto* pb = dynamic_cast<PowerButton*>(&toggleButton))
    {
        ...
        auto color = toggleButton.getToggleState() ? Colours::dimgrey : Colour(187u, 154u, 247u);
...
void RotarySliderWithLabels::paint(juce::Graphics& g)
{
    ...
    g.setColour(Colour(187u, 154u, 247u));
...
void ResponseCurveComponent::resized()
{
    ...
    for (auto gDb : gain)
    {
        ...
        g.setColour(gDb == 0.f ? Colour(187u, 154u, 247u) : Colours::darkgrey);
    ...
    for (auto gDb : gain)
    {
        ...
        g.setColour(gDb == 0.f ? Colour(187u, 154u, 247u) : Colours::lightgrey);
